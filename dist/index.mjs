...
var uid = localUid ? localUid : uuid.v1();
  ...
  init() {
    return __async(this, null, function* () {
      ...
      if (__privateGet(this, _socket) !== null) {
        this.socket = io(__privateGet(this, _socket).baseUrl, {
...
export { CustomAxiosInstance, ENV, RESPONSE_CODES, decrypt, encrypt, getDateDDMMYYYY, getDateDayDiff, getDateMMDDYYYY, getDateYYYYMMDD, getMessenger, localStg, numberFormat, numberToText, numberWithZero, regexps, request, sessionStg };
