...
__export(src_exports, {
  ...
  getDateDayDiff: () => getDateDayDiff,
  getDateMMDDYYYY: () => getDateMMDDYYYY,
...
var CustomAxiosInstance = class {
  ...
  constructor(axiosConfig, {
    ...
    this.instance = import_axios.default.create(axiosConfig);
...
var Messenger = class {
  constructor({
    ...
    if (polling === null) {
      this.socket = (0, import_socket.io)(baseURL, __spreadValues({
        path: "/messenger",
